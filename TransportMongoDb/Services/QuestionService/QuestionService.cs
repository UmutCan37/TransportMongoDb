...
namespace TransportMongoDb.Services.QuestionService
{
    public class QuestionService : IQuestionService
    {
        ...
        {
            var value = await _questionCollection.Find(x => true).ToListAsync();
            return _mapper.Map<List<ResultQuestionDto>>(value);
        ...
        public Task UpdateQuestionAsync(UpdateQuestionDto updateQuestionDto)
        {
            ...
            return _questionCollection.FindOneAndReplaceAsync(x => x.QuestionId == updateQuestionDto.QuestionId, value);
        }
