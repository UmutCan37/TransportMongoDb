...
namespace TransportMongoDb.Services.ShipmentServices
{
    public class ShipmentService : IShipmentService
    {
        ...
        public Task UpdateShipmentAsync(UpdateShipmentDto updateShipmentDto)
        {
            ...
            return _shipmentCollection.FindOneAndReplaceAsync(x => x.ShipmentId == updateShipmentDto.ShipmentId, value);
        }
    }
}
